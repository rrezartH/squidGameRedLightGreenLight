...
const TIMIT_LIMIT = 90
let gameStat = "loading"
let isLookingBackward = true
let kokowaSfx = new Audio ('../audio/kokowa.mp3');
let scanSfx = new Audio ('../audio/scan.mp3');
...
class Player {
    ...
    run() {
        this.playerInfo.velocity = .002
    }

    stop() {
        gsap.to(this.playerInfo, {velocity: 0, duration: .001})
    }
